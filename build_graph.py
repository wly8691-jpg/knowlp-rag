...
def chunk_body(body: str, headings: list[str], name: str = "",
    ...
    for section in sections:
        ...
        text = re.sub(r'^#{1,4}\s+.*$', '', section, flags=re.MULTILINE)
